/**
 * @name ShowHiddenChannels_OLDEST
 * @author DevilBro
 ...
 * @updateUrl https://raw.githubusercontent.com/SeiyaGame/Discord-ShowHiddenChannels/main/ShowHiddenChannels.plugin.js
 */
...
module.exports = (_ => {
	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		downloadLibrary () {
			require("request").get("https://raw.githubusercontent.com/SeiyaGame/Discord-ShowHiddenChannels/main/0BDFDB.plugin.js", (e, r, b) => {
				if (!e && b && r.statusCode == 200) require("fs").writeFile(require("path").join(BdApi.Plugins.folder, "0BDFDB.plugin.js"), b, _ => BdApi.showToast("Finished downloading BDFDB Library", {type: "success"}));
				else BdApi.alert("Error", "Could not download BDFDB Library Plugin. Try again later or download it manually from GitHub: https://github.com/SeiyaGame/Discord-ShowHiddenChannels");
			});
		}
